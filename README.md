...
A high-performance **C++ 3D Editor** designed for visualizing, analyzing, and managing **Structure from Motion (SfM)** data and point clouds.
...
| Action | Control |
| :--- | :--- |
| **Rotate** | Right Click (Hold) |
| **Pan** | Middle Click (Hold) |
| **Zoom** | Mouse Scroll |
| **Focus Center** | `F` Key |
| **Movement (Free)** | W, A, S, D, Q, E |
